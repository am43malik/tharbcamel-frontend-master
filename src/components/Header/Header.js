...
console.log(props);
	...
	<div className="container-fluid">
        <Link to="/"><img src='/tharblogowp.jpeg' height={50} width={100} alt="eventfavicon" /></Link>
	...
	<div className="collapse navbar-collapse" id="navbarResponsive">
		<ul className="navbar-nav ml-auto" id="nav">
			...
			{props.id==="2"?<Link  className="nav-link active" to="/generatereport">Generate Report</Link>:<Link  className="nav-link"  to="/generatereport">Generate Report</Link>}
			</li>
			<li className="nav-item">
			{props.id==="3"?<Link  className="nav-link active" to="/previousreports">Previous Reports</Link>:<Link  className="nav-link"  to="/previousreports">Previous Reports</Link>}
			</li>
			{/* <li className="nav-item">
